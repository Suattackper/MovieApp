...
public final class ActivityResetPasswordBinding implements ViewBinding {
  ...
  private ActivityResetPasswordBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatButton btnSignin, @NonNull TextInputEditText confirmPassword,
      ...
      @NonNull ConstraintLayout lyToolbar, @NonNull TextInputEditText newPassword,
  ...
  public static ActivityResetPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResetPasswordBinding((ConstraintLayout) rootView, btnSignin,
          confirmPassword, imvBack, imvLogoApp, lyDescIntro, lySigninAuth, lyToolbar, newPassword,
          txtSigninLabel);
    }
