...
public final class FragmentOTPVerifyBinding implements ViewBinding {
  ...
  private FragmentOTPVerifyBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ConstraintLayout lyToolbar, @NonNull AppCompatTextView txtForgotPass,
  ...
  public static FragmentOTPVerifyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_o_t_p_verify, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentOTPVerifyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOTPVerifyBinding((ConstraintLayout) rootView, btnSignin, editEmail,
          imvBack, imvLogoApp, lyDescIntro, lySigninAuth, lyToolbar, txtForgotPass, txtSigninLabel);
    }
