...
public final class MovieImagengangItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static MovieImagengangItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MovieImagengangItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.movie_imagengang_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MovieImagengangItemBinding bind(@NonNull View rootView) {
