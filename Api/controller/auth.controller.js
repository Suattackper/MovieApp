...
exports.registered = async (req, res) => {
  try {
   ...
   random = (Math.floor(Math.random() * 900000) + 100000);
    ...
    await sendEmail('Movie App', 'tranthao28062003@gmail.com', subject, text, html); // No HTML needed
...
exports.login = async (req, res) => {
  try {
    ...
    const account = await AccountModel.findOne({ email: req.body.email });
    // const test =  createJWT();cre
    

    
    

    // const ok = verifyAcessToken('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiVGhhbyIsImV4cGlyZXNJbiI6IjEwcyIsImlhdCI6MTcxNjg2NTQ2MX0.ah_J_LJn9wpieS1xrY_Ak5ApGmSNl1XenKARb1hxrtQ');
    // console.log(ok);
